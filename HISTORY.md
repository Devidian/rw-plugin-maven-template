...
## [0.1.0] - 2026-09-23 | JSON-only template runtime

- change: new plugins use the JSON-only world-settings lifecycle from OZ Tools and no longer include a legacy Properties reader.
